        ...
        <div className="min-h-screen bg-fondo">
            <section className="relative h-96 flex items-center justify-center">
                ...
                <div className="relative z-10 text-center space-y-6">
                    ...
                    <Link to="/tienda"><button className="bg-[#00A3E0] text-white px-8 py-3 rounded-lg hover:bg-gray-400  transition-colors duration-500 hover:text-black cursor-pointer">Ver productos</button></Link> 
                </div>
            </section>
